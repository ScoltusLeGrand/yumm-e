      ...
      <body className="bg-black text-white">
        ...
        <nav className="flex items-center justify-between p-6 border-b border-zinc-800 bg-black/50 backdrop-blur-md sticky top-0 z-50">
          ...
          <div className="flex gap-8 items-center">
            ...
            <Link href="/lessons" className="hover:text-blue-400 transition">Lessons</Link>
            <Link href="/partnerships" className="hover:text-pink-400 transition">Partenariats</Link>
